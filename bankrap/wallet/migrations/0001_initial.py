    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_type', models.CharField(choices=[('DEPOSIT', 'Deposit'), ('WITHDRAW', 'Withdrawal'), ('HOLD', 'On Hold'), ('REFUND', 'Returned'), ('LOAN_RCV', 'Loan Received'), ('LOAN_PAY', 'Loan Payment'), ('LOAN_REP', 'Repayment Received')], max_length=10)),
